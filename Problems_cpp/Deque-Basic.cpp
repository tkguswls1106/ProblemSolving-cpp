...
int main()
{
    // deque은 마치 vector의 기능에 push_front(넣을값)와 pop_front()를 추가한 자료구조라고 보고 사용해도 무방할듯 하다. 실제로 사용법도 거의 동일하다.
    // 덱(deque)의 개념은, 큐(queue)와 비슷하지만 큐와 다르게 삽입과 삭제가 앞, 뒤 양쪽으로 모두 가능하다.
